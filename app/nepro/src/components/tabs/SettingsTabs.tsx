...
export function SettingsTab({ connectedWallet, onDisconnect }: SettingsTabProps) {
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-slate-700">Mainnet Beta</span>
              </div>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-6 bg-slate-50 border-slate-200">
          <div className="text-sm text-slate-600 space-y-2">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-slate-900 font-mono text-xs">Coming soon...</span>
            </div>
          </div>
        </Card>
      </div>
